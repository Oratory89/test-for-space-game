...
extern struct brl_max2d_image_TImage_obj* _m_game_pewpewTImage;
...
struct _m_game_TCharacter_obj {
	...
	struct brl_max2d_image_TImage_obj* __m_game_tcharacter_w1texture;
	BBFLOAT __m_game_tcharacter_w1x;
	BBFLOAT __m_game_tcharacter_w1y;
	BBFLOAT __m_game_tcharacter_w1s;
	BBFLOAT __m_game_tcharacter_w1a;
	BBFLOAT __m_game_tcharacter_w1d;
